...
export class QuestionControllerService {
     ...
     * @throws ApiError
     */
    public static listQuestionUsingGet(): CancelablePromise<BaseResponse_List_Question_> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static listQuestionVoUsingGet(): CancelablePromise<BaseResponse_List_QuestionVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/question/list/vo/all',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
     ...
     * @throws ApiError
     */
    public static listQuestionSubmitUsingGet(): CancelablePromise<BaseResponse_List_QuestionSubmit_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/question/question_submit/list/all',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
